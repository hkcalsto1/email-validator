...
// Providers known to block SMTP probing but are legitimate
const KNOWN_PROVIDERS = new Set([
  ...
  'sina.com', 'sina.cn',
  'sohu.com',
  '139.com', '189.cn', '21cn.com', 'tom.com',
  // Microsoft
  'outlook.com', 'hotmail.com', 'live.com', 'msn.com',
  'hotmail.co.uk', 'hotmail.fr', 'hotmail.de', 'hotmail.it', 'hotmail.es',
  'live.co.uk', 'live.fr', 'live.de', 'live.it', 'live.es',
  'live.com.au', 'live.com.br', 'live.com.ar', 'live.com.mx',
  // Yahoo
  'yahoo.com', 'ymail.com',
  'yahoo.co.jp', 'yahoo.co.uk', 'yahoo.fr', 'yahoo.de',
  'yahoo.it', 'yahoo.es', 'yahoo.com.au', 'yahoo.com.br',
  // Apple
...
async function validateEmail(email) {
  ...
  if (smtp === 'unverifiable') {
    if (KNOWN_PROVIDERS.has(domain)) {
      return { email: trimmed, status: 'likely-valid', reason: 'Known provider — mailbox unverifiable but domain is legitimate' };
    }
